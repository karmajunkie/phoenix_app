...
config :present,
  ecto_repos: [Present.Repo]

# Configures the endpoint
config :present, Present.Web.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "J5u3lcy5VkvYgZgDwGSN0ueoIWqF+BsQ2yU5dwHhS5Ev3w0AXNazk/mIdK7P5huJ",
  render_errors: [view: Present.Web.ErrorView, accepts: ~w(json)],
  pubsub: [name: Present.PubSub,
...
config :guardian, Guardian,
  ...
  issuer: "Present", # The entry to put into the token as the issuer. This can be used in conjunction with verify_issuer
  ...
  serializer: Present.GuardianSerializer # The serializer that serializes the 'sub' (Subject) field into and out of the token
